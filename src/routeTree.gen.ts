...
import { Route as DemoSentryBadEventHandlerRouteImport } from "./routes/demo.sentry.bad-event-handler.tsx";
...
const DemoSentryBadEventHandlerRoute = DemoSentryBadEventHandlerRouteImport
  .update({
